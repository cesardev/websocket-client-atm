...
//        	FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(localDir + "\\src\\main\\resources\\assets\\tray\\TrayNotification.fxml"));
//        	FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("D:\\Neo-crm\\Workspace-test\\websocket-client-atm\\src\\main\\resources\\assets\\TrayNotification.fxml"));

        	FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/neo/mx/atm/fxcomponents/tray/resources/TrayNotification.fxml"));
    ...
    public void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getResource("/com/neo/mx/atm/fxcomponents/tray/resources/info.png");
                paintHex = "#2C54AB";
                break;

            case NOTICE:
                imageLocation = getClass().getResource("/com/neo/mx/atm/fxcomponents/tray/resources/notice.png");
                paintHex = "#8D9695";
                break;

            case SUCCESS:
                imageLocation = getClass().getResource("/com/neo/mx/atm/fxcomponents/tray/resources/success.png");
                paintHex = "#009961";
                break;

            case WARNING:
                imageLocation = getClass().getResource("/com/neo/mx/atm/fxcomponents/tray/resources/warning.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getResource("/com/neo/mx/atm/fxcomponents/tray/resources/error.png");
                paintHex = "#CC0033";
                break;
